...
@Component({
    selector: 'app-signin-form-boutique',
    imports: [
...
export class SigninFormBoutiqueComponent {
    ...
    onSignIn() {
        this.isLoading = true;
        this.authService.login(this.email, this.password, environment.boutiqueRole).subscribe({
            next: res => {
